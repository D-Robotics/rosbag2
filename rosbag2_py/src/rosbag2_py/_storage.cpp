...
PYBIND11_MODULE(_storage, m) {
  ...
  .def(
    pybind11::init<
      std::string, std::string, uint64_t, uint64_t, uint64_t, std::string, std::string, bool, bool, uint64_t>(),
    pybind11::arg("uri"),
    ...
    pybind11::arg("delay") = true,
    pybind11::arg("delay_timeout_ms") = 200)
  ...
  .def_readwrite(
    "delay",
    &rosbag2_storage::StorageOptions::delay)
  .def_readwrite(
    "delay_timeout_ms",
    &rosbag2_storage::StorageOptions::delay_timeout_ms);
